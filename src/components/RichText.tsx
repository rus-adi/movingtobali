...
const base = "text-gray-700 leading-7";
...
export const richTextCls =
  base +
  " [&_p]:my-4" +
  " [&_a]:font-medium [&_a]:text-emerald-800 [&_a]:underline [&_a]:underline-offset-4 [&_a]:transition-colors [&_a]:duration-200 [&_a:hover]:text-emerald-900" +
  ...
  " [&_ul>li]:before:bg-emerald-50 [&_ul>li]:before:text-[12px] [&_ul>li]:before:font-bold [&_ul>li]:before:text-emerald-800" +
  " [&_ol]:my-4 [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-5" +
  " [&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-stone-300 [&_blockquote]:pl-4 [&_blockquote]:text-gray-800" +
  " [&_table]:w-full [&_table]:border-collapse" +
  " [&_th]:border-b [&_th]:border-gray-200 [&_th]:bg-gray-50 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:text-xs [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-wide [&_th]:text-gray-700" +
